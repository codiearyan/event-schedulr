	...
	return (
		...
		>
			...
			<ScrollView>
				...
				>
					<View>
						<Text className="mb-2 font-medium text-sm text-text-primary">
							Full Name
						</Text>
						<TextInput
							value={name}
						...
						/>
						{errors.name && (
							<Text className="mt-1 text-error text-xs">{errors.name}</Text>
						)}
					</View>
					...
					<View>
						...
						/>
						{errors.email && (
							<Text className="mt-1 text-error text-xs">{errors.email}</Text>
						)}
					</View>
				</Animated.View>
