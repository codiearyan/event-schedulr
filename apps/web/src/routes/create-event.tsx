...
// import { Calendar, CalendarClock, FileText, Image, MessageSquare, Sparkles } from "lucide-react";
...
// 				toast.success(
// 					`Event created! Access code: ${accessCode?.code}`,
// 					{ duration: 10000 },
// 				);
// 			} else {
...
// 	return (
//         <div className="bg-bg-main min-screen w-full  text-white">
...
// 							>
// 								Set as current event (will replace any existing current event)
// 							</Label>
// 						</div>
...
function CreateEventRoute() {
	const navigate = useNavigate();
	const { eventId } = useSearch({ from: "/create-event" });
