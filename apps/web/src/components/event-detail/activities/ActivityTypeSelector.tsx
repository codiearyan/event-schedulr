...
const activityTypes: {
...
}[] = [
	{
		...
		color: {
			...
			selected: "border-blue-500 bg-gradient-to-br from-blue-500/20 to-blue-600/10",
			iconBg: "bg-zinc-800/80 text-zinc-400 group-hover:bg-blue-500/20 group-hover:text-blue-400",
	...
	},
	{
		...
		color: {
			...
			selected: "border-emerald-500 bg-gradient-to-br from-emerald-500/20 to-emerald-600/10",
			iconBg: "bg-zinc-800/80 text-zinc-400 group-hover:bg-emerald-500/20 group-hover:text-emerald-400",
			iconBgSelected: "bg-emerald-500 text-white shadow-lg shadow-emerald-500/30",
	...
	},
	{
		...
		color: {
			...
			selected: "border-amber-500 bg-gradient-to-br from-amber-500/20 to-amber-600/10",
			iconBg: "bg-zinc-800/80 text-zinc-400 group-hover:bg-amber-500/20 group-hover:text-amber-400",
	...
	},
	{
		...
		color: {
			...
			selected: "border-purple-500 bg-gradient-to-br from-purple-500/20 to-purple-600/10",
			iconBg: "bg-zinc-800/80 text-zinc-400 group-hover:bg-purple-500/20 group-hover:text-purple-400",
	...
	},
	{
		...
		color: {
			...
			selected: "border-rose-500 bg-gradient-to-br from-rose-500/20 to-rose-600/10",
			iconBg: "bg-zinc-800/80 text-zinc-400 group-hover:bg-rose-500/20 group-hover:text-rose-400",
			...
			{activityTypes.map(({ type, label, description, icon: Icon, color }) => {
				...
				return (
					...
					>
						...
						>
							<Icon className={`h-7 w-7 transition-transform duration-200 ${isSelected ? "scale-110" : "group-hover:scale-110"}`} />
						</div>
